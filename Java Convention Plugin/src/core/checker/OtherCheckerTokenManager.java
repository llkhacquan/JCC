/* Generated By:JavaCC: Do not edit this line. OtherCheckerTokenManager.java */
...
/** Constructor. */
public OtherCheckerTokenManager(JavaCharStream stream){
...
/** Constructor. */
public OtherCheckerTokenManager(JavaCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
...
protected Token jjFillToken()
{
   ...
   t = MyOtherToken.newToken(jjmatchedKind, curTokenImage);
