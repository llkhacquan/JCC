/* Generated By:JavaCC: Do not edit this line. CommentChecker.java */
 ...
 */
  final public void RUNSIGNEDSHIFT() throws ParseException {
    if (getToken(1).kind == GT && ((MyCommentToken) getToken(1)).realKind == RUNSIGNEDSHIFT) {
  ...
  final public void RSIGNEDSHIFT() throws ParseException {
    if (getToken(1).kind == GT && ((MyCommentToken) getToken(1)).realKind == RSIGNEDSHIFT) {
...
/* Annotation Types. */
  ...
  private boolean jj_3R_73() {
    ...
    jj_semLA = getToken(1).kind == GT && ((MyCommentToken) getToken(1)).realKind == RSIGNEDSHIFT;
  ...
  private boolean jj_3R_74() {
    jj_lookingAhead = true;
    jj_semLA = getToken(1).kind == GT && ((MyCommentToken) getToken(1)).realKind == RUNSIGNEDSHIFT;
    jj_lookingAhead = false;
  ...
  public CommentChecker(java.io.InputStream stream, String encoding) {
  ...
  /** Constructor. */
  public CommentChecker(java.io.Reader stream) {
  ...
  public CommentChecker(CommentCheckerTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
  }
  ...
  /** Reinitialise. */
  public void ReInit(CommentCheckerTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
  }
