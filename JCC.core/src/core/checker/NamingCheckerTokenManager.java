/* Generated By:JavaCC: Do not edit this line. NamingCheckerTokenManager.java */
...
/** Constructor. */
public NamingCheckerTokenManager(JavaCharStream stream){
...
/** Constructor. */
public NamingCheckerTokenManager(JavaCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
...
protected Token jjFillToken()
{
   ...
   t = MyNamingToken.newToken(jjmatchedKind, curTokenImage);
